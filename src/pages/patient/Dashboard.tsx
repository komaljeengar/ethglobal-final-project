          ...
          <div className="relative flex-1 max-w-md">
            <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4" />
                <Input
                  ...
                  className="pl-10 text-gray-900 placeholder-purple-400 bg-white border-purple-200"
                  value={searchQuery}
        ...
        <Card className="bg-gradient-to-r from-indigo-500 to-purple-600 text-white">
          <CardContent className="p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <Button className="w-full bg-white/20 hover:bg-white/30 border-white/30 text-white" onClick={() => navigate('/patient/records')}>
                <PlusCircle className="h-4 w-4 mr-2" />
                Upload Records
              </Button>
              <Button className="w-full bg-white/20 hover:bg-white/30 border-white/30 text-white" onClick={() => navigate('/patient/ai-chat')}>
                <Brain className="h-4 w-4 mr-2" />
                AI Health Chat
              </Button>
              <Button className="w-full bg-white/20 hover:bg-white/30 border-white/30 text-white" onClick={() => navigate('/patient/permissions')}>
            ...
            <CardContent className="p-4">
              ...
              <div className="flex gap-1 mt-3">
                {activePermissions.map((_, i) => (
                  <div key={i} className={`h-2 flex-1 rounded ${i < activePermissions.length ? "bg-gradient-to-r from-purple-500 to-blue-500" : "bg-gray-200"}`} />
                ))}
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-3">
                {upcomingAppointments.map((appointment, index) => (
                  <div key={index} className="flex items-center justify-between p-3 bg-gradient-to-r from-blue-50 via-white to-purple-50 rounded-lg border border-blue-200">
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-1">
                        <p className="font-medium text-sm text-blue-900">{appointment.time}</p>
                        <Badge variant="outline" className="text-xs border-blue-200 text-blue-700">
                          {appointment.status}
                        </Badge>
                      </div>
                      <p className="text-sm text-blue-700">{appointment.patient}</p>
              ...
              {/* Active Permissions */}
              <div>
                <h4 className="font-semibold text-sm mb-3">Active Permissions</h4>
                <div className="space-y-2">
                  {activePermissions.slice(0, 3).map((permission, index) => (
                    <div key={index} className="flex items-center justify-between p-2 bg-gradient-to-r from-purple-50 via-white to-blue-50 rounded-lg border border-purple-200">
                      <div className="flex-1">
